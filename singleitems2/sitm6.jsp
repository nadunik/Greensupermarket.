<%-- 
    Document   : sitm6
    Created on : Dec 28, 2023, 10:33:27 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://i0.wp.com/www.freshmeat.lk/php_content/uploads/2020/06/Chicken_liver1.jpg?w=1200&ssl=1" width="100%" id="Mainimg">
            </div>
