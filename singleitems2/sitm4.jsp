<%-- 
    Document   : sitm4
    Created on : Dec 28, 2023, 10:33:06 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/113272--01--1555687222.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Keells</h4>
                <p>Chicken Meat Balls</p>
                <p>500g</p>
                <h2>Rs.750/=</h2>
