<%-- 
    Document   : sit14
    Created on : Dec 29, 2023, 3:39:29 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://m.media-amazon.com/images/W/MEDIAX_792452-T2/images/I/81vH09PsnnL._AC_UF894,1000_QL80_.jpg" width="100%" id="Mainimg">
            </div>
