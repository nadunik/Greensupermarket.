<%-- 
    Document   : sin13
    Created on : Dec 28, 2023, 9:39:37 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/113771--01--1555687824.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Food</h6>
                <h4>Kist</h4>
                <p>Strawberry Flavoured Melon Jam</p>
                <P>300g</P>
                <h2>Rs.280/=</h2>
