<%-- 
    Document   : sin14
    Created on : Dec 28, 2023, 9:39:45 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/113803--01--1697601032.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Food</h6>
                <h4>Marmite</h4>
                <p>Marmite Yeast Extract</p>
                <P>200g</P>
                <h2>Rs.1020/=</h2>
