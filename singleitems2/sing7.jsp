<%-- 
    Document   : sing7
    Created on : Dec 29, 2023, 4:44:38 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.spar.lk/cdn/shop/products/anchor-newdale-set-yoghurt-80g-chilled-802.jpg?v=1628226372" width="100%" id="Mainimg">
            </div>
