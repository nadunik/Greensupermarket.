<%-- 
    Document   : sing8
    Created on : Dec 29, 2023, 4:44:47 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://supersavings.lk/wp-content/uploads/2020/11/Ambewela-Yoghurt-80ml-x-6pcs-Bundle.jpg" width="100%" id="Mainimg">
            </div>
