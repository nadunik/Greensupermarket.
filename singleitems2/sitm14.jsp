<%-- 
    Document   : sitm14
    Created on : Dec 28, 2023, 10:35:07 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://bringmaalu.lk/cdn/shop/products/pdt3_750x.png?v=1676350038" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Fresh Cleaned Handella</h4>
                <p>500g</p>
                <p></p>
                <h2>Rs.1700/=</h2>
