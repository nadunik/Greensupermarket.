<%-- 
    Document   : sitm11
    Created on : Dec 28, 2023, 10:34:32 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://bringmaalu.lk/cdn/shop/files/FullSizeRender_750x.jpg?v=1699327554" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Sea Crab Claws</h4>
                <p>1kg</p>
                <p></p>
                <h2>Rs.1200/=</h2>
