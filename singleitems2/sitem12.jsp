<%-- 
    Document   : sitem12
    Created on : Dec 28, 2023, 7:19:45 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.tastingtable.com/img/gallery/why-you-should-always-buy-small-eggplants/l-intro-1658245418.jpg" width="100%" id="Mainimg">
            </div>
