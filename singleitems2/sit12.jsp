<%-- 
    Document   : sit12
    Created on : Dec 29, 2023, 3:39:13 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://s3.ap-southeast-1.amazonaws.com/control-center.builtamart.com/public/products/2285-009-22-2023-100942-703.jpg?rand=0.6792023208312115" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Fruits</h6>
                <h4>Mangosteen</h4>
                <p>1kg</p>
                <p></p>
                <h2>Rs.800/=</h2>
