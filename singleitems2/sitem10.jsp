<%-- 
    Document   : sitem10
    Created on : Dec 28, 2023, 6:59:53 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://5.imimg.com/data5/SELLER/Default/2021/6/QD/FM/CN/121454703/big-onion-small-onion-500x500.jpg" width="100%" id="Mainimg">
            </div>
