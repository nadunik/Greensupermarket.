<%-- 
    Document   : sitem11
    Created on : Dec 28, 2023, 7:19:30 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.usatoday.com/gcdn/-mm-/ff08101970c9b392424972bf0f5861a9adca4d8f/c=0-110-2122-1304/local/-/media/2020/07/29/USATODAY/usatsports/potatoes-lamb-weston-getty.jpeg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Vegetables</h6>
                <h4>Potato</h4>
                <p>1kg</p>
                <h2>Rs.400/=</h2>
