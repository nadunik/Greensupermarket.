<%-- 
    Document   : sin8
    Created on : Dec 28, 2023, 9:38:37 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/115342--01--1592216263.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Food</h6>
                <h4>Prima</h4>
                <p>Noodles Family Pack</p>
                <p>335g</p>
                <h2>Rs.420/=</h2>
