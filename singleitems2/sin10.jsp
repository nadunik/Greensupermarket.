<%-- 
    Document   : sin10
    Created on : Dec 28, 2023, 9:39:00 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/114096--01--1555689111.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Food</h6>
                <h4>Harischandra</h4>
                <p>White String Hopper Rice Flour</p>
                <p>700g</p>
                <h2>Rs.250/=</h2>
