<%-- 
    Document   : sitem1
    Created on : Dec 28, 2023, 6:53:32 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://exat8rt6fi5.exactdn.com/wp-content/uploads/2022/05/french-beans-01.jpg?strip=all&lossy=1&fit=600%2C600&ssl=1" width="100%" id="Mainimg">
            </div>
