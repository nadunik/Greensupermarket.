<%-- 
    Document   : sitm10
    Created on : Dec 28, 2023, 10:34:15 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://bringmaalu.lk/cdn/shop/files/image_8436339f-d28b-4fa0-bfea-438ee3d36f07_750x.png?v=1685466747" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Fresh Seer Fish(cut)</h4>
                <p>1kg</p>
                <p></p>
                <h2>Rs.4000/=</h2>
