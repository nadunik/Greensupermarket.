<%-- 
    Document   : sitm8
    Created on : Dec 28, 2023, 10:33:51 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://i0.wp.com/www.freshmeat.lk/php_content/uploads/2020/11/20201019_070626.jpg?w=1080&ssl=1" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Fresh Boiler Chicken(cut)</h4>
                <p>500g</p>
                <p></p>
                <h2>Rs.650/=</h2>
