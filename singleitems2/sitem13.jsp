<%-- 
    Document   : sitem13
    Created on : Dec 28, 2023, 7:19:55 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://lyofood.com/cdn/shop/articles/LYOFOOD-freeze-dried-organic-beetroot-powders-EU-01.jpg?v=1490710701" width="100%" id="Mainimg">
            </div>
