<%-- 
    Document   : sit5
    Created on : Dec 29, 2023, 3:38:19 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.melissas.com/cdn/shop/products/3-count-image-of-dragon-fruit-red-fruit-33579304157228_600x600.jpg?v=1679408764" width="100%" id="Mainimg">
            </div>
