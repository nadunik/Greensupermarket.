<%-- 
    Document   : sing6
    Created on : Dec 29, 2023, 4:44:31 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/117359--01--1597747793.jpeg" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Dairy Products</h6>
                <h4>Chello</h4>
                <p>Yogurt</p>
                <p>1</p>
                <h2>Rs.120/=</h2>
