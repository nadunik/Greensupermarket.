<%-- 
    Document   : sitm2
    Created on : Dec 28, 2023, 10:32:42 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/113262--01--1555687221.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Crescent</h4>
                <p>Sliced Chicken Ham</p>
                <p>150g</p>
                <h2>Rs.540/=</h2>
