<%-- 
    Document   : sitm3
    Created on : Dec 28, 2023, 10:32:55 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/140-140/113253--01--1555687221.webp" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Crescent</h4>
                <p>Chicken Sausages</p>
                <p>250g</p>
                <h2>Rs.560/=</h2>
