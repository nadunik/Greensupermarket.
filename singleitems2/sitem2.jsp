<%-- 
    Document   : sitem2
    Created on : Dec 28, 2023, 6:54:28 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://www.growingproduce.com/wp-content/uploads/2023/07/w_Manessa_Cabbage_Rijk-Zwaan_gallery.jpg" width="100%" id="Mainimg">
            </div>
