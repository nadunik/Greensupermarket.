<%-- 
    Document   : sitm15
    Created on : Dec 28, 2023, 10:35:19 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://bringmaalu.lk/cdn/shop/products/frozen-oyster-mushroom-500x500_750x.webp?v=1676563419" width="100%" id="Mainimg">
            </div>
