<%-- 
    Document   : sitem8
    Created on : Dec 28, 2023, 6:58:52 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://resources.markon.com/sites/default/files/styles/large/public/pi_photos/Citrus_Limes_Hero.jpg" width="100%" id="Mainimg">
            </div>
