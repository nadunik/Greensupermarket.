<%-- 
    Document   : sitm13
    Created on : Dec 28, 2023, 10:34:56 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://bringmaalu.lk/cdn/shop/files/image_29973fc1-1408-4fd5-90fb-9a3a0bb744bd_750x.png?v=1684235382" width="100%" id="Mainimg">
            </div>
            <div class="single-item-detail">
                <h6 style="color: #009933;">Shop/Meat&Seafood</h6>
                <h4>Fresh Thalapath Cubes</h4>
                <p>500g</p>
                <p></p>
                <h2>Rs.2400/=</h2>
