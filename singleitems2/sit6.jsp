<%-- 
    Document   : sit6
    Created on : Dec 29, 2023, 3:38:28 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://agroponiente.com/wp-content/uploads/2023/08/sandia-blanca-sin-semillas-Agroponiente.png" width="100%" id="Mainimg">
            </div>
