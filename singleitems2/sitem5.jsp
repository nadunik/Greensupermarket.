<%-- 
    Document   : sitem5
    Created on : Dec 28, 2023, 6:57:41 PM
    ...
    <body>
        ...
        <section id="itemdetail" class="section-p1">
            <div class="single-item-image">
                <img src="https://images.immediate.co.uk/production/volatile/sites/30/2022/08/Pumpkin-sliced-open-f2b8dde.jpg?resize=768,574" width="100%" id="Mainimg">
            </div>
