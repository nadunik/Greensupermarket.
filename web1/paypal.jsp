<%-- 
    Document   : paypal
    Created on : Dec 31, 2023, 11:41:09 PM
            ...
            paypal.Buttons({
                createOrder: function(data, actions) {
                    ...
                    return actions.order.create({
                        purchase_units: [{
                            amount: {
                                value: '1800.00' // Replace with your dynamic total amount
                            }
                        }]
                    });
                },
                onApprove: function(data, actions) {
                    ...
                    return actions.order.capture().then(function(details) {
                        ...
                        // (this part is crucial for security, and you should implement it on your server)
                        alert('Transaction completed by ' + details.payer.name.given_name);
                        // Redirect or perform any other necessary actions after successful payment
                    });
                }
...
<body>
    ...
    <section id="basket-add" class="section-p1">
        ...
        <div id="subtotal">
            ...
            <script>
                document.querySelector('#subtotal button').addEventListener('click', initiatePayPalPayment);
            </script>
        </div>
    </section>
